...
const Contact =({id,name,email,number,handleDelete}) =>{
    ...
    return(
        <div className="pt-2 pb-2 flex flex-row  items-center border-b border-gray-light">
            <div className="w-6 text-gray-light text-xl border-gray-light flex justify-center items-center">{id}</div>
            ...
            <div className="w-1/3 text-gray-light text-xl flex justify-center items-center">{number}</div>
